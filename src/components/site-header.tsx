      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8 h-16">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center rounded-lg bg-brand-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm shadow-brand-500/30 hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-500/40 transition-all hover:shadow-md hover:shadow-brand-500/40"
          >
            Hire Josh for Sales
          </Link>
        </div>
          ...
          <div className="flex flex-col px-4 py-4 gap-1">
            ...
            <div className="mt-2 grid grid-cols-2 gap-2">
              <Link
                href="/login"
                onClick={() => setOpen(false)}
                className="rounded-lg border border-ink-200 px-4 py-2.5 text-center text-sm font-medium text-ink-700"
              >
                Log in
              </Link>
              <Link
